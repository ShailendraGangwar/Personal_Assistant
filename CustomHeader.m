...
- (id)init
{
    ...
    if (self) {
        ...
        _lightColor = [UIColor colorWithRed:100.0f/255.0f green:179.0f/255.0f blue:216.0f/255.0f alpha:1.0];
        _darkColor = [UIColor colorWithRed:232.0/255.0 green:170.0/255.0 blue:92.0/255.0 alpha:1.0];
    }
    return self;
}
