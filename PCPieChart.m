...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
		...
		self.titleFont = [UIFont fontWithName:@UNIVERS_55_ROMAN_LATIN size:9];//[UIFont boldSystemFontOfSize:20];
		self.percentageFont = [UIFont fontWithName:@UNIVERS_45_STD_LIGHT size:12];//[UIFont boldSystemFontOfSize:14];
		self.showArrow = YES;
