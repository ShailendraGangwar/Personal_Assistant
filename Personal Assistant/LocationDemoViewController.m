...
@synthesize latitudeLabel,latitudeText,longitudeLabel,longitudeText,addressLabel,addressTextView,speedText,mapView;
...
- (void)locationManager:(CLLocationManager *)manager didUpdateToLocation:(CLLocation *)newLocation fromLocation:(CLLocation *)oldLocation
{
    ...
    if (currentLocation != nil) {
        longitudeText.text = [NSString stringWithFormat:@"%.8f", currentLocation.coordinate.longitude];
        latitudeText.text = [NSString stringWithFormat:@"%.8f", currentLocation.coordinate.latitude];
    }
    ...
    speedText.text = [NSString stringWithFormat:@"%f",currentLocation.speed];
